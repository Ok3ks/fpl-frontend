            ...
            children: [
              ...
              Column(
                  ...
                  children: List.generate(2, (index) {
                    return TransferTile(data: data.data?['leagueWeeklyReport']['bestTransferIn'], index:index);
                  })),
...
TransferTile({super.key, required this.data, required this.index});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    List<double> playerIds = List.from(
                    [
                      double.tryParse(data[index]['playerIn']) ?? 0, double.tryParse(data[index]['playerOut']) ?? 0,
                    ]
    );
    return SizedBox(
    width: 600,
