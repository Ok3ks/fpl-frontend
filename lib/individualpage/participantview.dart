                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        widget.participantId =
                                            parseParticipantIdFromUrl(participantIdController.text);
                                        ...
                                        if (participantIdController.text.length > 1) {
                                          ...
                                          setState(() {
                                            widget.participantId = parseParticipantIdFromUrl(participantIdController.text);
                                          });
                                        }
                                      },
                                    )
...
class ParticipantStatsView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ParticipantStatsView> createState() => ParticipantStatsViewState();
}
